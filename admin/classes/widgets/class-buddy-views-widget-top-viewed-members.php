...
class Buddy_Views_Widget_Top_Viewed_Members extends Buddy_Views_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = __( 'Display a list of your most viewed members on your site.', BUDDY_VIEWS_TEXT_DOMAIN );
		$this->widget_id          = 'buddy_views_most_viewed_members';
		$this->widget_name        = __( 'Buddy Views Most Viewed Members', BUDDY_VIEWS_TEXT_DOMAIN );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => __( 'Most Viewed Members', BUDDY_VIEWS_TEXT_DOMAIN ),
			...
			'number' => array(
				...
				'max'   => '',
				'std'   => 5,
				'label' => __( 'Number of members to show', BUDDY_VIEWS_TEXT_DOMAIN ),
			),
		);
		parent::__construct();
	}
			...
			foreach ( $result as $data ) {
				...
				<div class="item-avatar">
					...
					<div class="item">
						...
						<div class="item-meta">
								<span class="activity"><?php echo sprintf( _n( '%s view', '%s views', $views_count, BUDDY_VIEWS_TEXT_DOMAIN ), $views_count ); ?></span>
						</div>
					</div>
				</li>
				<?php
